...
# 7. UI Frames
crop_and_save(
    (1305, 130, 1415, 235), os.path.join(OUT_DIR, "frames", "frame-rect-1.png")
)
crop_and_save(
    (1420, 130, 1525, 235), os.path.join(OUT_DIR, "frames", "frame-oval-1.png")
)
crop_and_save(
    (1305, 235, 1415, 340), os.path.join(OUT_DIR, "frames", "frame-rect-2.png")
)
crop_and_save(
    (1420, 235, 1525, 340), os.path.join(OUT_DIR, "frames", "frame-round-1.png")
)
...
# 9. Magic Circles
crop_and_save(
    (860, 650, 1430, 820), os.path.join(OUT_DIR, "sections", "magic-circles.png")
)

# 10. Effects & Overlays
crop_and_save(
    (1140, 875, 1520, 990), os.path.join(OUT_DIR, "effects", "magic-overlays.png")
)
