import type { AlternateSceneResult, ArtDirectionProfile, ArtDirectionProfileVersion, ArtDirectionSpec, ArtifactType, Aspect, AuthResponse, AvatarIdentity, AwakeningStage, Biography, BiographyGuardianReport, BiographySection, BiographySourceRef, CanonStatus, CanonicalDiceRead, ChroniclePainting, CommunitySymbol, Constellation, ConstellationStageInfo, CrossAspectBond, EncounterFrame, GalleryArtifact, GalleryCollection, GalleryCollectionItem, GatheringContribution, GatheringSession, GenerationType, GroupAnchorType, GroupMemory, GroupMemoryAnchor, GroupMemoryTag, GroupTagType, IntegrationEvent, LegendaryFigure, LocalThread, ManifestationType, MemoryObject, NarrativeIntensity, NPCKnowledgeProjection, NumericDiceRoll, OpenQuestion, ParticipantRef, PerspectiveComparison, PlayerPreferences, PortraitGenerationCandidate, PortraitVersion, PrivateNote, ProbablePath, ProbablePathStatus, PromptCompilationResult, ProviderCapabilities, ReflectionSession, RelatedMemorySuggestion, Relic, RelicEvent, ResolvedArtDirection, ResolvedScene, Seed, SoulResources, SoulprintProfile, SpiritualFraming, StoryMark, StyleReviewResult, User, VisualAvatarProfile, VisualEntityVersion, WorldEntityType, WorldMemory, WorldMemoryPlacement, WorldVisualCandidate } from '../types';
