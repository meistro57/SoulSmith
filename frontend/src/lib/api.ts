import type { AlternateSceneResult, Aspect, AuthResponse, AvatarIdentity, AwakeningStage, Biography, BiographyGuardianReport, BiographySection, BiographySourceRef, CanonStatus, CanonicalDiceRead, ChroniclePainting, CommunitySymbol, Constellation, ConstellationStageInfo, CrossAspectBond, EncounterFrame, GatheringContribution, GatheringSession, GenerationType, GroupAnchorType, GroupMemory, GroupMemoryAnchor, GroupMemoryTag, GroupTagType, IntegrationEvent, LocalThread, ManifestationType, MemoryObject, NarrativeIntensity, NumericDiceRoll, OpenQuestion, ParticipantRef, PerspectiveComparison, PlayerPreferences, PortraitGenerationCandidate, PortraitVersion, PrivateNote, ProbablePath, ProbablePathStatus, PromptCompilationResult, ProviderCapabilities, ReflectionSession, RelatedMemorySuggestion, Relic, RelicEvent, ResolvedScene, Seed, SoulResources, SoulprintProfile, SpiritualFraming, StoryMark, User, VisualAvatarProfile, VisualEntityVersion, WorldEntityType, WorldVisualCandidate } from '../types';
